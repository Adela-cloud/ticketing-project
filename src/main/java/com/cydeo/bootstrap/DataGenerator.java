...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
       ...
       rs.save(adminRole);
       this is how we do without spring, but with spring,
       instead of creating objects we need to create beans.
       this can be done with dependency injection.
        */
